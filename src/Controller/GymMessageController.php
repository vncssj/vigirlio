...
class GymMessageController extends AppController
{
	...
	public function composeMessage()
    {
		...
		{	
			...
			if($saved)
			{$this->Flash->success(__("Sucesso! Mensagem enviada com sucesso."));}
			else
			{$this->Flash->error(__("Erro! A mensagem não pôde ser enviada, tente novamente."));}			
		}
    }
	...
	public function deleteMessage($did)
	{
		...
		{
			$this->Flash->success(__("Sucesso! Mensagem excluída com sucesso."));
			return $this->redirect(["action"=>"inbox"]);
		}
	}	
}
