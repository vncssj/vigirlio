...

{
	...
	public function viewBooking($booking_id){ 
		...
		<div class="modal-header">
			...
			<button type="button" class="close" data-dismiss="modal" aria-label="Ok"><span aria-hidden="true">&times;</span></button>
				...
				<h4 class="modal-title" id="gridSystemModalLabel"><?php echo __("Detalhe de reserva");?></h4>
				...
				<div class="row">
					...
					<div class="col-sm-12 col-md-6">
						...
						<div class="col-md-5 col-sm-6">
							...
							<label class="book"><b><?php echo __("Nome");?></b></label>
						...
						<div class="col-md-5 col-sm-6">
							...
							<label class="book"><b><?php echo __("Gênero");?></b></label>
						...
						<div class="col-md-5 col-sm-6">
							...
							<label class="book"><b><?php echo __("Celular");?></b></label>
						...
						<!-- <div class="col-md-5 col-sm-6">
							...
							<label class="book"><b><?php echo __("Endereço");?></b></label>
						...
						<!-- <div class="col-md-5 col-sm-6">
							...
							<label class="book"><b><?php echo __("Cidade");?></b></label>
					...
					<div class="col-sm-12 col-md-6">
						...
						<!-- <div class="col-md-5 col-sm-6">
							...
							<label class="book"><b><?php echo __("Estado");?></b></label>
						...
						<!-- <div class="col-md-5 col-sm-6">
							...
							<label class="book"><b><?php echo __("Código postal");?></b></label>
						...
						<div class="col-md-5 col-sm-6">
							...
							<label class="book"><b><?php echo __("Nome da classe");?></b></label>
						...
						<div class="col-md-5 col-sm-6">
							...
							<label class="book"><b><?php echo __("Data de Reserva");?></b></label>
						...
						<div class="col-md-5 col-sm-6">
							...
							<label class="book"><b><?php echo __("Tipo de reserva");?></b></label>
						...
						<div class="col-md-5 col-sm-6">
							...
							<label class="book"><b><?php echo __("Preço");?></b></label>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-default" data-dismiss="modal"><?php echo __("Ok");?>
	...
	public function addCategory() {
		...
		?>	
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="gridSystemModalLabel"><?php echo __("Adicionar/Remover Categoria");?></h4>
			</div>
			<div class="modal-body">
				<div class="row">
					<div class="col-sm-4 col-sm-offset-1">
						<input type="text" class="cat_name form-control" placeholder="<?php echo __("Insira o nome da categoria");?>" required>
					</div>
					<div class="col-sm-4">
						<button class="add-category btn btn-flat btn-success" data-url="<?php echo $this->request->base."/GymAjax/saveCategory";?>"><?php echo  __("Adicionar categoria");?></button>
					</div>
				</div>
				<hr>
				<div class="row">
							...
							<?php
								foreach($categories as $category) {
									echo "<tr id='row-{$category->id}'>
										<td>{$category->name}</td>
										<td><button class='del-category btn btn-flat btn-danger' del-id='{$category->id}' data-url='{$this->request->base}/GymAjax/deleteCategory'>".__("Excluir")."</button></td>
									</tr>";
								}
							?>
							</tbody>
	...
	public function saveCategory() {
		...
		if($category_table->save($category)) {
			$id = $category->id;
			$return[0] = "<tr id='row-{$id}'><td>{$name}</td><td><button del-id='{$id}' class='del-category btn btn-flat btn-danger' data-url='{$this->request->base}/GymAjax/deleteCategory'>".__("Deletar")."</button></td></tr>";
	...
	public function addInstalmentPlan() {
		...
		<script>
					...
					if(number != "" && duration!="")
					{
						if(regex.test(number)) 
						{
							if(number.length<=3)
							{
								...
								var message = "<?php echo __("Insira no máximo 3 números apenas."); ?>";
								alert(message);
							}
						}else{
							var message = "<?php echo __("Digite apenas o número."); ?>";
							alert(message);
						}	
					}else{
						var message = "<?php echo __("Digite o número ou selecione a duração."); ?>";
						alert(message);
					}
				});
				// Script End Add Plan
				...
				$("body").on("click",".del-plan",function(){
					...
					var ajaxurl = $(this).attr("data-url");
					var cdata = {did:did};
					var confirmMsg = "<?php echo __("Tem certeza que deseja excluir este registro?"); ?>";
		...
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-label="Ok"><span aria-hidden="true">&times;</span></button>
			<h4 class="modal-title" id="gridSystemModalLabel"><?php echo __("Adicionar/Remover Plano de Parcelamento");?></h4>
		</div>
		<div class="modal-body">
			<div class="row">
				<div class="col-sm-4">
					<input type="text" name="number" id="number" class="cat_name form-control" placeholder="<?php echo __("Digite o número da duração");?>">
				</div>
				<div class="col-sm-3 no-padding">
					<select name="duration" id="duration" class="form-control">
						<option value=""><?php echo __("Selecione a duração");?></option>
						<option value="Dias"><?php echo __("Dias");?></option>
						<option value="Semana"><?php echo __("Semana");?></option>
						<option value="Mês"><?php echo __("Mês");?></option>
						<option value="Ano"><?php echo __("Ano");?></option>						
					</select>
				</div>
				<div class="col-sm-2">
					<button class="add-plan btn btn-flat btn-success" data-url="<?php echo $this->request->base."/GymAjax/savePlan";?>"><?php echo  __("Adicionar categoria");?></button>
				</div>
			</div>
			<hr>
			<div class="row">
						...
						<tbody>
							...
							foreach($plans as $plan) {
								echo "<tr id='row-{$plan->id}'>
									...
									<td><button class='del-plan btn btn-flat btn-danger' del-id='{$plan->id}' data-url='{$this->request->base}/GymAjax/deletePlan'>".__("Deletar")."</button></td>
									</tr>";
							}
							?>
						</tbody>
	...
	public function savePlan() {
		...
		if($plan_table->save($plan)) {
			$id = $plan->id;
			$return[0] = "<tr id='row-{$id}'><td>{$number} {$duration}</td><td><button del-id='{$id}' class='del-plan btn btn-flat btn-danger' data-url='{$this->request->base}/GymAjax/deletePlan'>".__("Deletar")."</button></td></tr>";
...

	{
		...
		<div class="modal-header">
			...
			<h4 class="modal-title" id="gridSystemModalLabel"><?php echo __("Adicionar/Remover Função");?></h4>
			...
			<div class="row">
				...
				<form class="validateForm">
					...
					<div class="col-sm-4 col-sm-offset-1">
						...
						<input type="text" class="role_name form-control validate[custom[onlyLetterSp],maxSize[30]]" placeholder="<?php echo __("Digite o papel");?>">

					</div>

					<div class="col-sm-4">

						<button class="save-role btn btn-flat btn-success" data-url="<?php echo $this->request->base."/GymAjax/saveRole";?>"><?php echo  __("Adicionar papel");?></button>
					...
					<table class="table" id="roles_list">
...

						{
...

							{
								...
								<td><button class='del-role btn btn-flat btn-danger' del-id='{$role->id}' data-url='{$this->request->base}/GymAjax/deleteRole/{$role->id}'>".__("Deletar")."</button></td>

								</tr>";

							}

						}else{echo "<tr><td colspan='2'>".__("Sem funções adicionadas")."</td></tr>";}
...

	{
...

		{
			...
			$return[0] = "<tr id='row-{$id}'><td>{$name}</td><td><button del-id='{$id}' class='del-role btn btn-flat btn-danger' data-url='{$this->request->base}/GymAjax/deleteRole/{$id}'>".__("Deletar")."</button></td></tr>";
...

	{
...

		{
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="gridSystemModalLabel"><?php echo __("Adicionar/Remover Especialização");?></h4>
			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<div class="col-sm-4 col-sm-offset-1">
						...
						<input type="text" class="spec_name form-control" placeholder="<?php echo __("Entrar na especialização");?>">

					</div>

					<div class="col-sm-4">

						<button class="save-spec btn btn-flat btn-success" data-url="<?php echo $this->request->base."/GymAjax/saveSpecialization";?>"><?php echo  __("Adicionar papel");?></button>
							...
							<?php
...

								{
...

									{
										...
										<td><button class='del-spec btn btn-flat btn-danger' del-id='{$spec->id}' data-url='{$this->request->base}/GymAjax/deleteSpecialization/{$spec->id}'>".__("Deletar")."</button></td>
									...
									echo "<tr id='empty_row'><td colspan='2'>".__("Nenhuma especialização adicionada")."</td></tr>";
...

	{
...

		{
			...
			$return[0] = "<tr id='row-{$id}'><td>{$name}</td><td><button del-id='{$id}' class='del-spec btn btn-flat btn-danger' data-url='{$this->request->base}/GymAjax/deleteSpecialization/{$id}'>".__("Deletar")."</button></td></tr>";
...

	{
		...
		<div class="modal-header">
			...
			<h4 class="modal-title" id="gridSystemModalLabel"><?php echo __("Adicionar/Remover Interesse");?></h4>
		...
		<div class="modal-body">
			...
			<div class="row">
				...
				<div class="col-sm-4 col-sm-offset-1">
					...
					<input type="text" class="interest form-control" placeholder="<?php echo __("Insira o interesse");?>">

				</div>

				<div class="col-sm-4">

					<button class="save-interest btn btn-flat btn-success" data-url="<?php echo $this->request->base."/GymAjax/saveInterest";?>"><?php echo  __("Adicionar interesse");?></button>
					...
					<table class="table" id="interest_list">
...

						{
...

							{
								...
								<td><button class='del-interest btn btn-flat btn-danger' del-id='{$row->id}' data-url='{$this->request->base}/GymAjax/deleteInterest/{$row->id}'>".__("Deletar")."</button></td>

								</tr>";

							}

						}else{echo "<tr id='empty_row'><td colspan='2'>".__("Nenhum registro adicionado ainda")."</td></tr>";}
...

	{
...

		{
			...
			$return[0] = "<tr id='row-{$id}'><td>{$interest}</td><td><button del-id='{$id}' class='del-interest btn btn-flat btn-danger' data-url='{$this->request->base}/GymAjax/deleteInterest/{$id}'>".__("Deletar")."</button></td></tr>";
...

	{
		...
		<div class="modal-header">
			...
			<h4 class="modal-title" id="gridSystemModalLabel"><?php echo __("Adicionar/Remover Fonte");?></h4>
		...
		<div class="modal-body">
			...
			<div class="row">
				...
				<div class="col-sm-4 col-sm-offset-1">
					...
					<input type="text" class="source form-control" placeholder="<?php echo __("Digite a fonte");?>">

				</div>

				<div class="col-sm-4">

					<button class="save-source btn btn-flat btn-success" data-url="<?php echo $this->request->base."/GymAjax/saveSource";?>"><?php echo  __("Adicionar fonte");?></button>
					...
					<table class="table" id="source_list">
						...
						<thead>
							...
							<tr>
								...
								<th><?php echo __("Lista de Fontes");?></th>
...

						{
...

							{
								...
								<td><button class='del-source btn btn-flat btn-danger' del-id='{$row->id}' data-url='{$this->request->base}/GymAjax/deleteSource/{$row->id}'>".__("Deletar")."</button></td>

								</tr>";

							}

						}else{echo "<tr><td colspan='2'>".__("Nenhum registro adicionado ainda")."</td></tr>";}
...

	{
...

		{
			...
			$return[0] = "<tr id='row-{$id}'><td>{$source}</td><td><button del-id='{$id}' class='del-source btn btn-flat btn-danger' data-url='{$this->request->base}/GymAjax/deleteSource/{$id}'>".__("Deletar")."</button></td></tr>";
	...
	public function levelsList() {
		...
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-label="Ok"><span aria-hidden="true">&times;</span></button>
			<h4 class="modal-title" id="gridSystemModalLabel"><?php echo __("Adicionar/Remover Níveis");?></h4>
		</div>
		<div class="modal-body">
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<input type="text" class="level form-control" placeholder="<?php echo __("Entrar no Nível");?>" maxLength="30">
				</div>
				<div class="col-sm-4">
					<button class="save-level btn btn-flat btn-success" data-url="<?php echo $this->request->base."/GymAjax/saveLevel";?>"><?php echo  __("Adicionar Nível");?></button>
				</div>
			</div>
			<hr>
			<div class="row">
						...
						<?php
							if(!empty($levels)) {
								foreach($levels as $row) {
									echo "<tr id='row-{$row->id}'>
									<td>{$row->level}</td>
									<td><button class='del-level btn btn-flat btn-danger' del-id='{$row->id}' data-url='{$this->request->base}/GymAjax/deleteLevel/{$row->id}'>".__("Deletar")."</button></td>
									</tr>";
								}
							}else{echo "<tr id='noRecord'><td colspan='2'>".__("Nenhum registro adicionado ainda")."</td></tr>";}
						?>
						</tbody>
					</table>
				</div>
	...
	public function saveLevel()	{
		...
		if($level_table->save($row)) {
			$id = $row->id;
			$return[0] = "<tr id='row-{$id}'><td>{$level}</td><td><button del-id='{$id}' class='del-level btn btn-flat btn-danger' data-url='{$this->request->base}/GymAjax/deleteLevel/{$id}'>".__("Deletar")."</button></td></tr>";
...

	{
		...
		if(!empty($results)){
			...
			echo "<div class='col-md-12' id='membership_cat_id' value='".$membership_cat_id."' style='padding-left: 0px;padding-bottom: 15px;'>Categoria de Plano de Aumento de Sócios: ".$this->GYMFunction->get_category_name($membership_cat_id)."</div>";

			echo $option="<div class='work_out_datalist_header'><div class='col-md-10'>

					<span class='col-md-3'>".__('Atividade')."</span>

					<span class='col-md-2'>".__('Jogos')."</span>

					<span class='col-md-2'>".__('Reps')."</span>

					<span class='col-md-2'>".__('KG')."</span>

					<span class='col-md-3'>".__('Tempo de descanso')."</span>
			...
			{			
				...
				echo $option="<div class='work_out_datalist savebtn'><div class='col-sm-10'>
					...
					<span class='col-md-2'>".$retrieved_data['sets']." ".__('Jogos')."</span>
			...
			echo "<label class='col-md-2 col-sm-2 col-md-12 control-label' for='note'>".__("Observação")."</label><div class='col-md-10 col-sm-10 col-md-12'><textarea id='note' class='form-control' name='note'>".$results[0]['description']."</textarea></div>";
		}else {			
			echo $option = "<div class='work_out_datalist'>

			<div class='col-md-12' id='membership_cat_id' value='".$membership_cat_id."' style='padding-left: 0px;padding-bottom: 15px;'>Categoria de Plano de Aumento de Sócios: ".$this->GYMFunction->get_category_name($membership_cat_id)."</div>

			<div class='col-sm-12' style='padding-left: 0px;'>

			<span class='col-md-10 text-left' style='padding-left: 0px;padding-bottom: 15px;'><strong>".__('Nenhum treino atribuído para hoje. Você pode adicionar dados abaixo.')."</strong></span>
			...
			<div class='form-group'>
				...
				<div class="col-md-6">
					...
					<select class="form-control level_list validate[required]" name="level_id">
						...
						<option value=''><?php echo __("Selecione o nível");?></option>
				...
				<div class="col-md-3">
					...
					<a href="javascript:void(0);" class="btn btn-default btn-flat level-list" data-url="<?php echo $this->request->base;?>/GymAjax/levelsList"><?php echo __("Adicionar Nível");?></a>
			...
			<div class='row'>
				...
				<div class='col-md-12'>
...

					{
						...
						echo "</div><label class='col-md-2 col-sm-2 col-md-12 control-label' for='note'>".__("Observação")."</label><div class='col-md-10 col-sm-10 col-md-12'><textarea id='note' class='form-control' name='note'></textarea></div>";
...

	{
...

		{
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="gridSystemModalLabel"><?php echo __("Editar/Excluir Medição");?></h4>
						...
						<table class="table" id="level_list">
							...
							<thead>
								...
								<tr>
									...
									<th><?php echo __("Medição");?></th>

									<th><?php echo __("Resultado");?></th>

									<th><?php echo __("Data da gravação");?></th>
...

							{
								...
								echo "<tr><td>".__("Nenhum dado encontrado.")."</td></tr>";
	...
	public function EventPlaceList() {
		...
		<script>
			$("body").on("click",".save-event-place",function(){
				...
				if(place_name != "") {		
					...
					var message = "<?php echo __("Digite o nome do local."); ?>";
					alert(message);
				}
			});
		</script>
		...
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-label="Ok"><span aria-hidden="true">&times;</span></button>
			<h4 class="modal-title" id="gridSystemModalLabel"><?php echo __("Adicionar/Remover Local do Evento");?></h4>
		</div>
		<div class="modal-body">
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<input type="text" class="place_name form-control" placeholder="<?php echo __("Insira o nome do local"); ?>" maxLength="40" id="place">
				</div>
				<div class="col-sm-4">
					<button class="save-event-place btn btn-flat btn-success" data-url="<?php echo $this->request->base."/GymAjax/saveEventPlace";?>"><?php echo  __("Adicionar lugar"); ?></button>
				</div>
			</div>
			<hr>
			<div class="row">
				<div class="col-sm-12 table table-striped">
					<table class="table" id="events_place_list">
						<thead>
							<tr>
								<th><?php echo __("Coloque o nome");?></th>
								<th><?php echo __("Ação");?></th>
								<th></th>
							</tr>
						</thead>
						...
						if(!empty($event_places)) {
							foreach($event_places as $place) {
								...
								<td>{$place->place}</td>
								<td><button class='del-event-place btn btn-flat btn-danger' del-id='{$place->id}' data-url='{$this->request->base}/GymAjax/deleteEventPlace/{$place->id}'>".__("Deletar")."</button></td>
								</tr>";
							}
						}else {
							echo "<tr id='empty_row'><td colspan='2'>".__("Nenhum lugar de evento adicionado")."</td></tr>";
							}
						?>
						</tbody>
					</table>
		...
		<script>
			$("body").on("blur","#place",function(){
				...
				if(validateEvent())
				{
					...
					var message = "<?php echo __("Qualquer caractere especial e números não são permitidos no nome do local.") ?>";
					alert(message)
					$("#place").val('');
	...
	public function viewGroupMember($gid) {
		...
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-label="Ok"><span aria-hidden="true">&times;</span></button>
			<h4 class="modal-title" id="gridSystemModalLabel"><?php echo __("Membros do grupo");?></h4>
		</div>
		<div class="modal-body">
		...
		<?php
			...
			echo "<tr>".__("Nenhum membro atribuído ainda.")."</tr>";
	...
	public function gymPay($mp_id,$due) {
		...
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-label="Ok"><span aria-hidden="true">&times;</span></button>
			<h4 class="modal-title" id="gridSystemModalLabel"><?php echo __("Adicionar Pagamento");?></h4>
		</div>
		<div class="modal-body">
		...
		<div class="form-group">
			<label class="col-sm-3 control-label" for="amount"><?php echo __("Quantidade paga");?><span class="text-danger">*</span></label>
			<div class="col-sm-8">
		...
		<div class="form-group">
			<label class="col-sm-3 control-label" for="payment_method"><?php echo __("Pagamento por");?><span class="text-danger">*</span></label>
			<div class="col-sm-8">
				...
				<?php }
					...
					<option value="Bank Transfer"><?php echo __("Transferência bancária");?></option>
				<?php } ?>	
				</select>
			</div>
		</div>
		<div class="col-sm-offset-2 col-sm-8">
        	 <!--<input type="submit" value="<?php echo __("Adicionar Pagamento");?>" name="add_fee_payment" class="btn btn-flat btn-success payment">-->
        	 <input type="button" value="<?php echo __("Adicionar Pagamento");?>" name="add_fee_payment" class="btn btn-flat btn-success payment" id='submit_button'>
        	 <div class="stripe">
	        	 <script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
		          data-key="<?php echo $this->GYMFunction->getSettings('stripe_publishable_key'); ?>"
		          data-description="Acesso por um ano"
		          data-locale="auto"
		          ></script>
	      	</div>
        </div>
		...
		<div class="modal-footer">
			<button type="button" class="btn btn-flat btn-default" data-dismiss="modal"><?php echo __("Ok");?></button>				
		</div>
	<?php
	}
...

	{
		...
		<div class="modal-header">
			...
			<h4 class="modal-title" id="gridSystemModalLabel"><?php echo __("Fatura");?></h4>
			...
			<tbody>
				...
				<tr>
					...
					<td align="right" width="24%">
						...
						<h5><?php echo __('Número da Fatura')." : ". $data[0]['mp_id'];?></h5>
						...
						<h5><?php $issue_date=$data[0]['created_date']->format("Y-m-d");
							...
							echo __('Data de emissão')." : ". $issue_date;?></h5>
			...
			<tbody>
				...
				<tr>
					...
					<td align="<?php echo $float_l;?>">
						...
						<h4><?php echo __('Pagamento para');?> </h4>

					</td>

					<td align="<?php echo $float_r;?>">

						<h4><?php echo __('Cobrança para');?> </h4>
		...
		<table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
			...
			<thead>
				...
				<tr>
					...
					<th class="text-center"> <?php echo __('Tipo de Membro');?></th>

					<!--<th class="text-center"> <?php echo __('Taxa de inscrição');?></th> -->

					<th class="text-center"> <?php echo __('Taxa de adesão');?></th>
		...
		<table width="100%" border="0">
			...
			<tbody>
				...
				<tr>
					...
					<td width="80%" align="<?php echo $float_r;?>"><?php echo __('Pagamento realizado :');?></td>
				...
				<tr>
					...
					<td width="80%" align="<?php echo $float_r;?>"><?php echo __('Valor devido  :');?></td>
		...
		<thead>
				...
				<tr>
					...
					<th class="text-center"><?php echo __('Método');?> </th>
		...
		<div class="modal-footer">
			...
			<div class="print-button pull-left">
				...
				<a href="<?php echo $this->request->base . "/MembershipPayment/printInvoice/{$mp_id}/{$type}";?>" target="_blank" class="btn btn-flat btn-success"><?php echo __("Imprimir"); ?></a>
...

	{
		...
		<div class="modal-body">
			...
			<div id="invoice_print"> 
				...
				<h4><?php echo __("Entradas de fatura");?></h4>
				...
				<table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
					...
					<thead>
						...
						<tr>
							...
							<th class="text-center"> <?php echo __('Entrada');?></th>

							<th class="text-center"> <?php echo __('Preço');?></th>

							<th class="text-center"> <?php echo __('Nome do usuário');?></th>					
				...
				<table width="100%" border="0">
					...
					<tbody>
						...
						<tr>
							...
							<td width="80%" align="<?php echo $float_r;?>"><?php echo __('Total geral :');?></td>
		...
		<div class="modal-footer">
			...
			<div class="print-button pull-left">
				...
				<a href="<?php echo $this->request->base . "/MembershipPayment/printInvoice/{$data[0]['id']}/{$type}";?>" target="_blank" class="btn btn-flat btn-success"><?php echo __("Imprimir"); ?></a>
...

	{
		...
		?>
			...
			<div class="modal-header">
				...
				<h3 class="modal-title" id="gridSystemModalLabel"><?php echo __("Detalhe do Aviso");?></h3>
			...
			<div class="modal-body">		
				...
				<div class="panel panel-white form-horizontal">
				  ...
				  <div class="form-group">
					...
					<label for="notice_title" class="col-sm-3"><?php echo __("Título do Aviso ");?>          : </label>
				  ...
				  <div class="form-group">
					...
					<?php echo __("Comentário de Aviso");?>                : </label>
				  ...
				  <div class="form-group">
					...
					<?php echo __("Data de início");?>    : </label>
