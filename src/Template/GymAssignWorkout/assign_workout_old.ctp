		...
		<div class="box-header">
			<section class="content-header">
			  <h1>
				...
				<?php echo $title;?>
				<small><?php echo __("Adicionar ficha de treino");?></small>
			  </h1>
			  <ol class="breadcrumb">
				<a href="<?php echo $this->Gym->createurl("GymAssignWorkout","workoutLog");?>" class="btn btn-flat btn-custom"><i class="fa fa-bars"></i> <?php echo __("Fichas de treino");?></a>
			  </ol>
			</section>
		</div>
		<hr>
