...
<section class="content">
	...
	<div class="col-md-12 box box-default">
		...
		/*	echo "<div class='form-group'>";
			...
			$radio = [
						['value' => 'male', 'text' => __('Homem'),"class"=>"gender"],
						['value' => 'female', 'text' => __('Mulher'),"class"=>"gender"]
					];
			...
			echo "<div class='form-group'>";
			echo '<label class="control-label col-md-2" for="email">'. __("Whatsapp").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6">';
