		...
		<div class="box-header">
			<section class="content-header">
			  <h1>
				...
				<?php echo __("Planos de Fidelização");?>
			...
			{ ?>
			  <ol class="breadcrumb">				
				<a href="<?php echo $this->Gym->createurl("Membership","add");?>" class="btn btn-flat btn-custom"><i class="fa fa-plus"></i> <?php echo __("Adicionar Plano");?></a>
			  </ol>
			  <?php } ?>
			</section>
		</div>
			...
			<table class="mydataTable table table-striped" width="100%">
				<thead>
					<tr>
						...
						<th><?php echo __("Taxa de inscrição");?></th>
				...
				<?php
					foreach($membership_data as $membership)
					{
						...
						//{ 
						// echo " <a href='{$this->Gym->createurl("Membership","viewActivity")}/{$membership->id}' class='btn btn-flat btn-info'>".__("Atividades Incluídas")."</a>";	
						//}
						echo "</td>"; }
						echo "</tr>";
