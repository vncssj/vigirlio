		...
		<div class="box-body">							    
			...
			?>
				...
				<div class="form-group col-md-3">
					<label for="exam_id"><?php echo __("Data deínicio");?></label>
				...
				<div class="form-group col-md-3">
					<label for="exam_id"><?php echo __("Data final");?></label>
				...
				<div class="form-group col-md-3 button-possition">
					...
					<input type="submit" class="btn btn-flat btn-success" value="<?php echo __("Ir");?>" name="view_attendance">
				</div>	
			...
			<thead>
				<tr>
					<th width="200px"><?php echo __("Data");?></th>
					<th><?php echo __("Dia");?></th>
					<th><?php echo __("Comparecimento");?></th>
				</tr>
			</thead>
			<tbody>
				<?php 
