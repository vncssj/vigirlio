...
$(document).ready(function() {
	...
	$(".mem_valid_from").on("change",function(ev){
		...
		if(membership != "")
		{
			...
			$(".valid_to").val("Selecione um plano");
		}
	});		
});
...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<?php	
			...
			echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="first_name">'. __("Primeiro Nome").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6">';
			...
			*/
			echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="last_name">'. __("Último nome").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6">';
			...
			echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="gender">'. __("Gênero").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6 checkbox">';
			$radio = [
						['value' => 'Homem', 'text' => __('Masculino'),"class"=>"gender"],
						['value' => 'Mulher', 'text' => __('Feminino'),"class"=>"gender"]
					];
			...
			echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="birth_date">'. __("Data de nascimento").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6">';
			...
			echo "<div class='form-group'>";
			echo '<label class="control-label col-md-2" for="assign_group">'. __("Grupo").'</label>';
			...
			echo "<a href='{$this->request->base}/GymGroup/addGroup/' class='btn btn-flat btn-default'>".__("Adicionar Grupo")."</a>";
			echo "</div>";	
			echo "</div>";
			echo "</fieldset>";
			...
			*/
			echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="mobile">'. __("Telefone").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6">';
			...
			echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="phone">'. __("WhatsApp").'</label>';
			echo '<div class="col-md-6">';
			...
			echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="height">'. __("Panturrilha").'</label>';
			echo '<div class="col-md-6">';
			...
			echo "<div id='anamnese' class='form-group'>";	
			...
			echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="documento">'. __("Ficha de Anamnese").'</label>';
			echo '<div class="col-md-4">';
			echo $this->Form->file("documento",["class"=>"form-control"]);
			$sa = ($edit && !empty($data['documento']));
			$dado = $data['documento'];
			if(empty($sa)){
			...
			*/			
			...
			echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="username">'. __("Nome do usuário").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6">';
			...
			echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="password">'. __("Senha").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6">';
			...
			echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="image">'. __("Imagem do Perfil").'</label>';
			echo '<div class="col-md-4">';
			...
			echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="assign_staff_mem">'. __("Selecione o membro da equipe").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6 module_padding">';			
			echo @$this->Form->select("assign_staff_mem",$staff,["default"=>$data['assign_staff_mem'],"empty"=>__("Selecione o membro da equipe"),"class"=>"form-control d-none validate[required]","id"=>"assign_staff_mem"]);
			echo "</div>";	
			echo '<div class="col-md-2">';
			echo "</div>";	
			echo "</div>";
			...
			*/
			echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="email">'. __("Primeira Avaliação").'</label>';
			echo '<div class="col-md-6">';
			...
			echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="email">'. __("Última Avaliação").'</label>';
			echo '<div class="col-md-6">';
			...
			<!--		<label><?php echo __("Tipo de membro");?></label>-->
			<!--	</div>-->
			<!--	<div class="col-md-6">-->
			<!--		<label class="radio-inline"><input type="radio" name="member_type" value="Member" class="membership_status_type" <?php echo ($edit && $data['member_type'] == "Member") ? "checked":"checked";?>><?php echo __("Membro");?></label>-->
			<!--		<label class="radio-inline"><input type="radio" name="member_type" value="Prospect" class="membership_status_type" <?php echo ($edit && $data['member_type'] == "Prospect") ? "checked":"";?>><?php echo __("Prospecto");?></label>-->
			...
			echo '<label class="control-label col-md-2" for="email">'. __("Filiação").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6 module_padding">';			
			echo @$this->Form->select("selected_membership",$membership,["default"=>$data['selected_membership'],"empty"=>__("Selecione a adesão"),"class"=>"form-control validate[required] membership_id"]);
			echo "</div>";	
			echo '<div class="col-md-2">';
			echo "<a href='{$this->request->base}/Membership/add/' class='btn btn-flat btn-default'>".__("Adicionar plano")."</a>";
			echo "</div>";	
			echo "</div>";				
			...
			echo "</div>";		
			echo '<div class="col-md-2">';
			echo "<a href='{$this->request->base}/ClassSchedule/addClass/' class='btn btn-flat btn-default'>".__("Adicionar classe")."</a>";
			echo "</div>";	
			echo "</div>";
			...
			?>
				<div class="form-group">
					<div class="control-label col-md-2">
						<label><?php echo __("Status de membro");?></label>
					</div>
					<div class="col-md-6">
						<label class="radio-inline"><input type="radio" name="membership_status" value="Prospect" class="membership_status" <?php echo ($edit && $data['membership_status'] == "Prospect") ? "checked":"";?>><?php echo __("Prospecto");?></label>
						<label class="radio-inline"><input type="radio" name="membership_status" value="Continue" class="membership_status" <?php echo ($edit && $data['membership_status'] == "Continue") ? "checked":"";?>><?php echo __("Em andamento");?></label>
						<label class="radio-inline"><input type="radio" name="membership_status" value="Expired" class="membership_status" <?php echo ($edit && $data['membership_status'] == "Expired") ? "checked":"";?>><?php echo __("Expirado");?></label>
						<label class="radio-inline"><input type="radio" name="membership_status" value="Dropped" class="membership_status" <?php echo ($edit && $data['membership_status'] == "Dropped") ? "checked":"";?>><?php echo __("Desistiu");?></label>
					</div>
				</div>	
			<?php
			}
			echo "<div class='form-group class-member'>";	
			echo '<label class="control-label col-md-2" for="email">'. __("Associação Válida De").'<span class="text-danger">*</span></label>';
			echo '<div class="col-md-2">';
			...
			echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="email">'. __("Primeira Data de Pagamento").'</label>';
			echo '<div class="col-md-6">';
			...
			echo "<br>";
			echo $this->Form->button(__("Salvar membro"),['class'=>"col-md-offset-2 btn btn-flat btn-success","name"=>"add_member"]);
			echo $this->Form->end();
		?>
