	...
	<div class="col-md-12 box box-default">		
		<div class="box-header">
			<section class="content-header">
			  ...
			  <ol class="breadcrumb">
				<a href="<?php echo $this->Gym->createurl("GymDailyWorkout","workoutList");?>" class="btn btn-flat btn-custom"><i class="fa fa-bars"></i> <?php echo __("Lista de treino");?></a>
				&nbsp;
		...
		<form method="post" class="form-horizontal validateForm"> 
         <div class="col-md-12">
			<h3 class="no-margin"><?php echo $member_name." - Treinos";?></h3>
		 </div>
		 <br><br><br>
        <div class="form-group">
			<label class="col-sm-1 control-label" for="curr_date"><?php echo __("Data");?></label>
			...
			<div class="col-sm-3">
			<input type="submit" value="<?php echo __("Ver treinos");?>" name="view_workouts" class="btn btn-flat btn-success" >
			</div>
		</div>
          </form>
		<?php
		...
		if(isset($workouts))
		{
			...
			{ ?>
				<div class="col-md-12">
				<?php 
				$workout_note = ($workout['note'] != '')?$workout['note']:__("Não");
				echo __("Descrição : ").$workout_note;?>
				</div>
