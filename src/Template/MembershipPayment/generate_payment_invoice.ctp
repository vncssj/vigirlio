...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		<div class="box-header">
			<section class="content-header">
				<h1>
					...
					<?php echo __("Gerar fatura de pagamento");?>
					<small><?php echo __("Pagamento");?></small>
				</h1>
				<ol class="breadcrumb">
					<a href="<?php echo $this->Gym->createurl("MembershipPayment","paymentList");?>" class="btn btn-flat btn-custom"><i class="fa fa-bars"></i> <?php echo __("Lista de Pagamentos");?></a>
				</ol>
			</section>
		</div>
		<hr>
		...
		<div class="form-group">
			<label class="col-md-2 control-label" for="day"><?php echo __("Membro");?><span class="text-danger">*</span></label>	
			<div class="col-md-8">
				<?php
				if($edit)
				{
				...
				echo $this->Form->select("user_id",$members,["default"=>($edit)?$data["member_id"]:"","empty"=>__("Selecione Membro "),"class"=>"mem_list","required"=>"true",($edit)?"disabled":""]);
				?>
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-2 control-label" for="membership"><?php echo __("Plano");?><span class="text-danger">*</span></label>
			<div class="col-md-8">
				<?php echo $this->Form->select("membership_id",$membership,["default"=>($edit)?$data["membership_id"]:"","empty"=>__("Selecione a adesão"),"class"=>"form-control gen_membership_id","data-url"=>$this->request->base . "/GymAjax/get_amount_by_memberships"]);?>		
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-2 control-label" for="total_amount"><?php echo __("Montante total");?><span class="text-danger">*</span></label>
			<div class="col-md-8">
		...
		<div class="form-group">
			<label class="col-md-2 control-label" for="begin_date"><?php echo __("Associação Válida De");?><span class="text-danger">*</span></label>
			<div class="col-md-3">
			...
			<div class="col-md-1 text-center">	<?php echo __("Até");?>			</div>
			<div class="col-md-4">
		...
		<div class="col-md-offset-2 col-md-8">
        	<input type="submit" value="Salvar" name="<?php echo __("Salvar");?>" class="btn btn-flat btn-success">
        </div>
		</form>
