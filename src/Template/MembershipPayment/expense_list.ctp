	...
	<div class="col-md-12 box box-default">		
		<div class="box-header">
			<section class="content-header">
				<h1>
					...
					<?php echo __("Lista de Despesas");?>
					<small><?php echo __("Despesa");?></small>
				</h1>
				<ol class="breadcrumb">
					<a href="<?php echo $this->Gym->createurl("MembershipPayment","addExpense");?>" class="btn btn-flat btn-custom"><i class="fa fa-plus"></i> <?php echo __("Adicionar Despesas");?></a>
				</ol>
			</section>
		</div>
		<hr>
		<div class="box-body">
		 <table id="payment_list" class="table table-striped" cellspacing="0" width="100%">
        	<thead>
            <tr>				
				<th><?php  echo __( 'Nome do Fornecedor', 'gym_mgt' ) ;?></th>
				<th><?php  echo __( 'Quantia', 'gym_mgt' ) ;?></th>				
				<th><?php  echo __( 'Data', 'gym_mgt' ) ;?></th>				
				<th><?php  echo __( 'Açao', 'gym_mgt' ) ;?></th>
            </tr>
			</thead>
			<tbody>
				<?php
