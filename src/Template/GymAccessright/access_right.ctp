	...
	<div class="col-md-12 box box-default">
		<div class="box-header">
			<section class="content-header">
				<h1>
					<i class="fa fa-key"></i>
					<?php echo __("Configurações de direito de acesso"); ?>
					<small><?php echo __("Direito de Acesso"); ?></small>
				</h1>
			</section>
		</div>
		<hr>
		<div class="box-body">
			<form name="student_form" action="" method="post" class="form-horizontal" id="access_right_form">
				<div class="row">
					...
					<div class="col-md-2 col-sm-3 col-xs-3 text-center"><?php echo __("Membro"); ?></div>
				...
				<div class="access_right_menucroll">
					<div class="row" style="display: none;">
						<div class="col-md-2 col-sm-3 col-xs-5 ">
							<span class="menu-label">
								<?php echo __("Membro da equipe"); ?> </span>
						</div>
						...
						<div class="col-md-2 col-sm-3 col-xs-2" style="display: none;">
							<div class="checkbox text-center">
								<label>
					...
					<div class="row" style="display: none;">
						<div class="col-md-2 col-sm-3 col-xs-5">
							<span class="menu-label">
								<?php echo __("Tipo de Membro"); ?> </span>
						</div>
						<div class="col-md-2 col-sm-3 col-xs-2">
							<div class="checkbox text-center">
								<label>
					...
					<div class="row">
						<div class="col-md-2 col-sm-3 col-xs-5">
							<span class="menu-label">
								<?php echo __("Horário de aula"); ?> </span>
						</div>
						<div class="col-md-2 col-sm-3 col-xs-2">
							<div class="checkbox text-center">
								<label>
					...
					<div class="row">
						<div class="col-md-2 col-sm-3 col-xs-5">
							<span class="menu-label">
								<?php echo __("Reserva de aulas"); ?> </span>
						</div>
						<div class="col-md-2 col-sm-3 col-xs-2">
							<div class="checkbox text-center">
								<label>
					...
					<div class="row">
						<div class="col-md-2 col-sm-3 col-xs-5">
							<span class="menu-label">
								<?php echo __("Exercícios atribuídos"); ?> </span>
						</div>
						<div class="col-md-2 col-sm-3 col-xs-2">
							<div class="checkbox text-center">
								<label>
					...
					<div class="row">
						<div class="col-md-2 col-sm-3 col-xs-5">
							<span class="menu-label">
								<?php echo __("Pagamento da Taxa"); ?> </span>
						</div>
						<div class="col-md-2 col-sm-3 col-xs-2">
							<div class="checkbox text-center">
								<label>
					...
					<div class="row" style="display: none;">
						<div class="col-md-2 col-sm-3 col-xs-5">
							<span class="menu-label">
								<?php echo __("Cronograma de Nutrição"); ?> </span>
						</div>
						<div class="col-md-2 col-sm-3 col-xs-2">
							<div class="checkbox text-center">
								<label>
					...
					<div class="row">
						<div class="col-md-2 col-sm-3 col-xs-5">
							<span class="menu-label">
								<?php echo __("Histórico de Assinatura"); ?> </span>
						</div>
						<div class="col-md-2 col-sm-3 col-xs-2">
							<div class="checkbox text-center">
								<label>
				...
				<div class="col-sm-offset-2 col-sm-8 row_bottom">
					...
					<input type="submit" value="<?php echo __("Salvar"); ?>" name="save_access_right" class="btn btn-flat btn-success">
				</div>
			</form>
			<!-- END -->
		</div>
