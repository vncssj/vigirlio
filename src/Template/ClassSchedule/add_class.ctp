...
<section class="content">
	...
	<div class="col-md-12 box box-default">
		<div class="box-header">
			<section class="content-header">
			  <h1>
				...
				<?php echo $title == 'Add Class Schedule'? 'Adicionar horário de aula' : 'Editar horário de aula';?>
		...
		<?php
			...
			echo '<label class="control-label col-md-2" for="email">'. __("Nome da classe").'<span class="text-danger"> *</span></label>';
			...
			echo "</div>";
			*/
			echo '<input type="hidden" name="assign_staff_mem" value="6">';
			...
			// }
			// echo "</div>";
			echo '<input type="hidden" name="assistant_staff_member" value="">';
			...
			echo "<div class='form-group'>";
			echo '<label class="control-label col-md-2" for="email">'. __("Taxas de reserva de aulas").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6">';
			...
			echo "<div class='form-group'>";
			echo '<label class="control-label col-md-2" for="email">'. __("Selecione os dias").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6">';
			$days = [
				"Sunday"	=>__("Domingo"),
				"Monday"	=>__("Segunda-Feira"),
				"Tuesday"	=>__("Terça-Feira"),
				"Wednesday"	=>__("Quarta-Feira"),
				"Thursday"	=>__("Quinta-Feira"),
				"Friday"	=>__("Sexta-Feira"),
				"Saturday"	=>__("Sábado")
			];
			...
			echo "<div class='form-group'>";
			echo '<label class="control-label col-md-2" for="start time">'. __("Início").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6 ">';
			...
			echo "<div class='form-group'>";
			echo '<label class="control-label col-md-2" for="end time">'. __("Final").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6 ">';
			...
			echo $this->Form->button(__("Tempo extra"),['type'=>'button','id'=>'add_time','class'=>"btn btn-flat btn-success col-md-offset-2","name"=>"add_class"]);
			echo "<br><br>";
			echo "<div class='time_list col-md-10 col-md-offset-2'>";?>
			<table class="table" id="myTable">
				<tr class="table-head"><th><?php echo __("Dias");?></th><th><?php echo __("Hora de início");?></th><th><?php echo __("Fim do tempo");?></th><th><?php echo __("Ação");?></th></tr>
				<tbody class="time_table">
					...
					if($edit)
					{
						...
						foreach($schedule_list as $schedule)
						{
							...
							$daysview = str_replace(array_keys($days), array_values($days), $schedule["days"]);
							?>
							<tr id='data'>
								<td><?php echo implode(", ", json_decode($daysview)); ?></td>
			...
			echo "<br>";
			echo "<br>";
			echo $this->Form->button(__("Salvar"),['class'=>"btn btn-flat btn-success col-md-offset-2 svcls","name"=>"add_class"]);
			echo $this->Form->end();
		?>
		</div>
...
$("#add_time").click(function(){
	...
	{
		alert("Selecione dias, hora de início e hora de término");
		return false;
	}
	...
	if(tmp_list!=''){
		...
		alert('Este horário de aula já foi adicionado.');
		}
});
...
function gettime(){
	...
	if(st >= nd){
		alert("Por favor, insira a hora válida.");
		return false;
	}else{
		return true;
	}
