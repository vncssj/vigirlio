		...
		<div class="row"><!-- Start Row2 -->
							...
							<div class="panel info-box panel-white">
								<div class="panel-body member">
									...
									<div class="info-box-stats">
										<p class="counter"><?php echo $members;?> <span class="info-box-title"><?php echo __("Membro");?></span></p>
									</div>
								</div>
							</div>
						</a>
						...
						<a href="<?php echo $this->request->base ."/staff-members/staff-list";?>">
							<div class="panel info-box panel-white">
								<div class="panel-body staff-member">
									...
									<div class="info-box-stats">
										<p class="counter"><?php echo $staff_members;?><span class="info-box-title">Pessoal</span></p>
									</div>
								</div>
							</div>
						</a>
							...
							<div class="panel info-box panel-white">
								<div class="panel-body group">
									...
									<div class="info-box-stats groups-label">
										<p class="counter"><?php echo $groups;?><span class="info-box-title"><?php echo __("Grupo");?></span></p>
									</div>
								</div>
							</div>
						</a>
						...
						<a href="<?php echo $this->request->base ."/gym-message/inbox";?>">
							<div class="panel info-box panel-white">
								<div class="panel-body message no-padding">
									...
									<div class="info-box-stats">
										<p class="counter"><?php echo $messages;?><span class="info-box-title"><?php echo __("Mensagem");?></span></p>
									</div>
								</div>
							</div>
						</a>
			...
			<div class="col-md-4 membership-list <?php echo $pull;?> col-sm-4 col-xs-12">
				...
				?>
					<div class="panel panel-white">
						<div class="panel-heading">
							<h3 class="panel-title"><?php echo __("Filiação");?></h3>						
						</div>
				...
				?>
					<div class="panel panel-white">
						<div class="panel-heading">
							<h3 class="panel-title"><?php echo __("Classificação Por Objetivos");?></h3>						
						</div>
						<div class="panel-body">
							<?php 
			...
			<div class="row inline"><!-- Start Row3 -->
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="panel panel-white">
						<div class="panel-heading">
							<h3 class="panel-title"><?php echo __("Relatório de Progresso de Peso");?></h3>						
						</div>
						<div class="panel-body">	
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="panel panel-white">
						<div class="panel-heading">
							<h3 class="panel-title"><?php echo __("Relatório de Progresso da Cintura");?></h3>						
						</div>
						<div class="panel-body">	
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="panel panel-white">
						<div class="panel-heading">
							<h3 class="panel-title"><?php echo __("Relatório de progresso da coxa");?></h3>						
						</div>
						<div class="panel-body">	
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="panel panel-white">
						<div class="panel-heading">
							<h3 class="panel-title"><?php echo __("Relatório de Progresso do Braço");?></h3>						
						</div>
						<div class="panel-body">	
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="panel panel-white">
					<div class="panel-heading">
						<h3 class="panel-title"><?php echo __("Relatório de Progresso da Panturrilha");?></h3>						
					</div>
					<div class="panel-body">	
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="panel panel-white">
					<div class="panel-heading">
						<h3 class="panel-title"><?php echo __("Relatório de progresso do peito");?></h3>						
					</div>
					<div class="panel-body">	
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="panel panel-white">
					<div class="panel-heading">
						<h3 class="panel-title"><?php echo __("Relatório de progresso de gordura");?></h3>						
					</div>
					<div class="panel-body">	
