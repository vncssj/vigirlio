...
<section class="content">
	<div id="main-wrapper">
		<div class="row"><!-- Start Row2 -->
						...
						<div class="panel info-box panel-white">
							<div class="panel-body member">
								...
								<div class="info-box-stats">
									<p class="counter"><?php echo $members;?> <span class="info-box-title"><?php echo __("Membros");?></span></p>
								</div>
							</div>
						</div>
					</a>
					...
					<a href="<?php echo $this->request->base ."/staff-members/staff-list";?>">
						<div class="panel info-box panel-white">
							<div class="panel-body staff-member">
								...
								<div class="info-box-stats">
									<p class="counter"><?php echo $staff_members;?><span class="info-box-title">Personal</span></p>
								</div>
							</div>
						</div>
					</a>
							...
							<div class="panel-body group">
								<img src="<?php echo $this->request->base;?>/webroot/img/dashboard/group.png" class="dashboard_background">
									<div class="info-box-stats groups-label">
										<p class="counter"><?php echo $groups;?><span class="info-box-title"><?php echo __("Objetivos");?></span></p>
									</div>
							</div>
						</div>
					</a>
					...
					<a href="<?php echo $this->request->base ."/gym-message/inbox";?>">
						<div class="panel info-box panel-white">
							<div class="panel-body message no-padding">
								...
								<div class="info-box-stats">
									<p class="counter"><?php echo $messages;?><span class="info-box-title"><?php echo __("Caixa de entrada");?></span></p>
								</div>
							</div>
						</div>
					</a>
			...
			<div class="col-md-4 membership-list <?php echo $pull;?> col-sm-4 col-xs-12">
				<div class="panel panel-white">
					<div class="panel-heading">
						<h3 class="panel-title"><a href="<?php echo $this->request->base;?>/membership/membership-list"><?php echo __("Planos de Fidelização");?></a></h3>
					</div>
					<div class="panel-body">
						...
						{
							$m_img = (!empty($ms["gmgt_membershipimage"])) ? $ms["gmgt_membershipimage"] : "Thumbnail-img.png"; 
							?>
							<p>
				...
				<div class="panel panel-white">
					<div class="panel-heading">
						<h3 class="panel-title"><a href="<?php echo $this->request->base;?>/gym-group/group-list"><?php echo __("Classificação por Objetivos");?></a></h3>						
					</div>
					<div class="panel-body">
						<?php 
			...
			<!-- End row2 -->
			<div class="row inline" style="display: none;"><!-- Start Row3 -->
