            ...
            <ul class="nav navbar-nav">
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
				  ...
				  <?php
				  echo $this->Html->image("../webroot/upload/{$user_img}",array("class"=>"img-circle","alt"=>"Imagem de Perfil")); ?>
                    <p>
                      <?php echo $session->read("User.display_name") . "-" . ucwords(str_replace("_"," ",$session->read("User.role_name")));?>
                      <small><?php echo __("Membro desde"); ?> <?php echo $this->Gym->get_db_format(date("F 'y",strtotime($session->read("User.join_date"))));?></small>
                    </p>
                  </li>
				  ...
				  {?>
					  <div class="pull-left">                     
					  <a href="<?php echo $this->request->base; ?>/AdminProfile/editProfile/<?php echo $session->read("User.id");?>" class="btn btn-default btn-flat"><?php echo __("Perfil"); ?></a>
					</div> 
				 <?php  
				  }
				  else{ ?>		 
                    <div class="pull-left">                     
					  <a href="<?php echo $this->request->base; ?>/GymProfile/viewProfile" class="btn btn-default btn-flat"><?php echo __("Perfil"); ?></a>
					</div>
				  <?php } ?>	
                    <div class="pull-right">
                      <a href="<?php echo $this->request->base;?>/Users/logout" class="btn btn-default btn-flat"><?php echo __("Sair"); ?></a>
                    </div>
                  </li>
                </ul>
              </li>
