		...
		<div class="box-header box_payment">
			<section class="content-header bread_payment">
				<h1>
					...
					<?php echo __("Relatório de presenças");?>
				...
				<ol class="breadcrumb">
					...
					&nbsp;
					<a href="<?php echo $this->Gym->createurl("Reports","attendanceReport");?>" class="btn btn-flat active btn-custom"><i class="fa fa-bar-chart"></i> <?php echo __("Relatórios de presenças");?></a>
					&nbsp;
		...
		<div class="box-body">
			<form method="post" id="attendance">  
				<div class="form-group col-md-3">
					<label for="exam_id"><?php echo __('Data de início');?></label><span class='text-danger'> *</span>
				...
				<div class="form-group col-md-3">
					<label for="exam_id"><?php echo __('Data final');?></label><span class='text-danger'> *</span>
				...
				<div class="form-group col-md-3 button-possition">
					...
					<input type="submit" name="attendance_report" Value="<?php echo __('Ir');?>"  class="btn btn-flat btn-success"/>
				</div>   	
			</form>
			<?php
			...
			{
				$options = Array(
					'title' => __('Relatórios de Presença de Membros','gym_mgt'),
					...
					'hAxis' => Array(
						'title' =>  __('Classe','gym_mgt'),
						'titleTextStyle' => Array('color' => '#66707e','fontSize' => 14,'bold'=>true,'italic'=>false,'fontName' =>'open sans'),
						'textStyle' => Array('color' => '#66707e','fontSize' => 10),
						'maxAlternation' => 2
					),
					'vAxis' => Array(
						'title' =>  __('Nº de Membros','gym_mgt'),
						'minValue' => 0,
						'maxValue' => 6,
						'format' => '#',
						'titleTextStyle' => Array('color' => '#66707e','fontSize' => 14,'bold'=>true,'italic'=>false,'fontName' =>'open sans'),
			...
			<?php if(isset($attendance)){ ?>
				<h3 class="report-head">
					<?php echo __("Lista de Relatórios de Presença");?>
				</h3>
				<table class="mydataTable table table-striped" width="100%">
					<thead>
						<tr>
							...
							<th><?php echo __('Data de Presença'); ?></th>
