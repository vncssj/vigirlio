	...
	<div class="col-md-12 box box-default">		
			...
			<section class="content-header bread_payment">
				<h1>
					<i class="fa fa-bar-chart"></i>
						<?php echo __("Relatório de treino mensal dos membros");?>
				...
				<ol class="breadcrumb">
					...
					{ ?>
						...
						&nbsp;
						<a href="<?php echo $this->Gym->createurl("Reports","paymentReport");?>" class="btn btn-flat btn-custom"><i class="fa fa-bar-chart"></i> <?php echo __("Relatório de Pagamento");?></a>
						&nbsp;
						<a href="<?php echo $this->Gym->createurl("Reports","monthlyworkoutreport");?>" class="btn active btn-flat btn-custom"><i class="fa fa-bar-chart"></i> <?php echo __("Relatórios de treino mensal dos membros");?></a>
					<?php
					}
					?>
				</ol>
		...
		<form method="post" class="validateForm">  
			...
			<div class="form-group col-md-3">
				<label for="member_id"><?php echo __("Selecione Sócio");?></label>	<?php echo $this->Form->select("member_id",$members,["empty"=>__("Selecione Membro"),"class"=>"validation[required] form-control",'required'=>'true']);?>			
			</div>
			<?php
			}
			?>
			<div class="form-group col-md-3">
				<label class="control-label" for="curr_month"><?php echo __("Mês");?></label>				
			...
			<div class="form-group col-md-3 button-possition">
				...
				<input type="submit" value="<?php echo __("IR");?>" name="monthlyreport" class="btn btn-flat btn-success">
			</div>
			...
			if($post)
			{
				...
				<div class="box-body">
					<table class="mydataTable table table-striped">
						<thead>
							<tr>
								<th><?php echo __("Data de Treino");?></th>
								<th><?php echo __("Nome do treino");?></th>
								<th><?php echo __("Jogos");?></th>
								<th><?php echo __("Reps");?></th>
								<th><?php echo __("Kg");?></th>
								<th><?php echo __("Tempo de descanso");?></th>
							</tr>
						</thead>
						<tbody>
							<?php			
				...
				{	
					echo "<i>".__('Nenhum treino encontrado.')."</i>";
				}
			}?>
		</form>
	</div>
