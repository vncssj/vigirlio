...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		<div class="box-header box_payment">
			<section class="content-header bread_payment">
			  <h1>
				...
				<?php echo __("Relatório de membros");?>
				<small><?php echo __("Relatórios");?></small>
			  </h1>
			  <ol class="breadcrumb">
			  	<a href="<?php echo $this->Gym->createurl("Reports","membershipReport");?>" class="btn btn-flat active btn-custom "><i class="fa fa-bar-chart"></i> <?php echo __("Relatórios de Membros");?></a>
				<!--&nbsp;
		...
		<?php 
		$options = Array(
			'title' => __('Relatório de membros','gym_mgt'),
		...
		<div class="list_table">
			<?php if(isset($data)){ ?>
				<h3 class="report-head">
					<?php echo __("Lista de relatórios de membros");?>
				</h3>
				<table class="mydataTable table table-striped" width="100%">
					<thead>
						<tr>
							...
							<th><?php echo __('Total de Membros');?></th>
						</tr>
					</thead>
					<tbody>
						<?php 
