		...
		<div class="box-header">
			<section class="content-header">
			  <h1>
				...
				<?php echo __("Classificação por Objetivos");?>
			  ...
			  <?php
				...
				{ ?>
			  <ol class="breadcrumb">
				<a href="<?php echo $this->Gym->createurl("GymGroup","addGroup");?>" class="btn btn-flat btn-custom"><i class="fa fa-plus"></i> <?php echo __("Adicionar Grupo");?></a>
			  </ol>
			  <?php } ?>
			</section>
		</div>
		...
		<table class="mydataTable table table-striped">
			<thead>
				<tr>
					...
					<th><?php echo __("Nome do grupo");?></th>
