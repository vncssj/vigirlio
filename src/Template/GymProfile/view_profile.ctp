	...
	<div id="main-wrapper"> 
		<div class="row">
					...
					<div class="qr-div">
						<div class="panel-heading">
							<div class="panel-title" style="margin: auto 20px;">
								<?php echo __("Use este código Qr para atender");?> 	
							</div>
						</div>		
						<?php
			...
			<div class="col-md-8 m-t-lg">
				<div class="panel panel-white">
					<div class="panel-heading">
						<div class="panel-title">
							<?php echo __("Configurações da conta");?> 	
						</div>
					</div>
					<div class="panel-body">
						<form class="form-horizontal" action="#" method="post" id="account_form">
							...
							<div class="form-group">
								<label for="inputEmail" class="control-label col-sm-2"><?php echo __("Nome");?></label>
								<div class="col-sm-10">
									<input type="Name" class="form-control " id="name" placeholder="Nome completo" value="<?php echo $session->read("User.display_name"); ?>" readonly="">									
								</div>
							</div>
							<div class="form-group">
								<label for="inputEmail" class="control-label col-sm-2"><?php echo __("Nome do usuário");?></label>
								<div class="col-sm-10">
									<input type="username" class="form-control " id="username" placeholder="Nome completo" value="<?php echo $data["username"];?>" readonly="">
								</div>
							</div>
							<div class="form-group">
								<label for="inputPassword" class="control-label col-sm-2 "><?php echo __("Senha atual");?><span class="text-danger">*</span></label>
								<div class="col-sm-10">
									<input type="password" class="form-control validate[required]" id="inputCPassword" placeholder='<?php echo __("Senha");?>' name="current_password">
								</div>
							</div>
							<div class="form-group">
								<label for="inputPassword" class="control-label col-sm-2"><?php echo __("Nova Senha");?><span class="text-danger">*</span></label>
								<div class="col-sm-10">
									<input type="password" class="form-control validate[required]" id="inputNPassword" placeholder='<?php echo __("Nova Senha");?>' name="password">
								</div>
							</div>
							<div class="form-group">
								<label for="inputPassword" class="control-label col-sm-2"><?php echo __("Confirmar Senha");?><span class="text-danger">*</span></label>
								<div class="col-sm-10">
									<input type="password" class="form-control validate[required]" id="inputCoPassword" placeholder='<?php echo __("Confirmar Senha");?>' name="confirm_password">
								</div>
							</div>
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-10">
									<button type="submit" class="btn btn-flat btn-success" name="save_change"><?php echo __("Salvar");?></button>
								</div>
							</div>
						</form>
					</div>		   
				...
				<div class="panel panel-white">
					<div class="panel-heading">
						<div class="panel-title"><?php echo __("Outra informação");?>	</div>
					</div>
					<div class="panel-body">
						<form class="form-horizontal" action="#" method="post" id="doctor_form">							
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="birth_date"><?php echo __("Data de nascimento");?><span class="text-danger">*</span></label>
								<div class="col-sm-10">
							...
							<!--<div class="form-group">-->
							<!--	<label for="address" class="control-label col-sm-2"><?php echo __("Endereço da cidade natal");?><span class="text-danger">*</span></label>-->
							<!--	<div class="col-sm-10">-->
							<!--		<input id="address" class="form-control validate[required]" type="text" name="address" value="<?php echo $data["address"];?>">-->
							<!--	</div>-->
							<!--</div>-->
							<!--<div class="form-group">-->
							<!--	<label for="city" class="control-label col-sm-2"><?php echo __("Cidade");?><span class="text-danger">*</span></label>-->
							<!--	<div class="col-sm-10">-->
							<!--		<input id="city" class="form-control validate[required]" type="text" name="city" value="<?php echo $data["city"];?>">-->
							<!--	</div>-->
							<!--</div>-->
							<div class="form-group">
								<label for="phone" class="control-label col-sm-2"><?php echo __("Número do celular");?><span class="text-danger">*</span></label>
								<div class="col-sm-10">
							...
							<div class="form-group">
								<label for="phone" class="control-label col-sm-2"><?php echo __("Telefone");?></label>
								<div class="col-sm-10">
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-10">
									<button type="submit" class="btn btn-flat btn-success" name="profile_save_change"><?php echo __("Salvar");?></button>
								</div>
							</div>
						</form>
					</div>
