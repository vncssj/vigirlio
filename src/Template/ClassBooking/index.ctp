...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<?php				
			...
			echo '<label class="control-label col-md-2" for="full_name">'. __("Nome completo").'<span class="text-danger"> *</span></label>';
			...
			$radio = [
						['value' => 'male', 'text' => __(' Masculino'),"class"=>"gender"],
						['value' => 'female', 'text' => __(' Feminino'),"class"=>"gender"]
					];
			...
			echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="mobile">'. __("Telefone/WhatsApp").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6">';
			...
			*/
			...
			echo "<fieldset><legend>". __('Informação da Classe')."</legend>";				
			echo "<br>";
			echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="class">'. __("Classe").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6">';	

			echo $this->Form->select("class_id",$class,["default"=>($edit)?$data["class_id"]:"","empty"=>__("Selecione a classe"),"class"=>"validation[required] form-control class",'required'=>'true','data-url'=>$this->request->base.'/ClassBooking/get_class_fees','id'=>'class_id']);
			echo "</div>";			
			echo "</div>";
			
			$book_type = [
						['value' => 'Demo', 'text' => __('Demo')],
						['value' => 'Paid Booking', 'text' => __('Reserva Paga')]
					];
			echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="booking_type">'. __("Tipo de reserva").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6">';			
			echo $this->Form->select("booking_type",$book_type,["default"=>($edit)?$data["booking_type"]:"","empty"=>__("Selecione o tipo de reserva"),"class"=>"validation[required] form-control book_type",'id'=>'booking_type']);
			echo "</div>";			
			echo "</div>";

			echo "<div class='form-group book_fee'>";	
			echo '<label class="control-label col-md-2" for="Booking_Fees">'. __("Taxas de reserva de aulas").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6">';
			echo "<div class='input-group'>";	
			...
			echo '<label class="control-label col-md-2" for="Booking Date">'. __("Data de Reserva").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6">';
			...
			echo '<label class="control-label col-md-2" for="class_type">'. __("Método de pagamento").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6">';			
			echo $this->Form->select("payment_by",$payment,["default"=>($edit)?$data["payment_by"]:"","empty"=>__("Clique aqui"),"class"=>'form-control','id'=>'payment_by']);
			echo "</div>";
			echo "</div>";
			...
			echo $this->Form->button(__("Salvar reserva"),['type'=>'button','id'=>'submit_button','class'=>"btn btn-flat btn-success submit_button","name"=>"save_booking"]);
			echo '<div class="stripe">
	        	 <script src="https://checkout.stripe.com/checkout.js" id="stripe" class="stripe-button"
		          ...
		          data-description="Pagamento 100% Seguro"
		          data-locale="pt-BR"
				  data-button="Pagar com cartão"
		          ></script>
	      	</div>';
			echo "</div>";
...
$(document).ready(function(){
	...
	$('.submit_button').on('click',function(){
		...
		if(class_id != '' && booking_type != ''){
			...
			alert('Selecione a classe e o tipo de reserva.')
		}
