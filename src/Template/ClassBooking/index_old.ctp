...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<?php				
			...
			echo '<label class="control-label col-md-2" for="Booking_Fees">'. __("Taxa de reserva").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6">';
			echo "<div class='input-group'>";	
			...
			echo '<div class="col-md-6">';			
			echo $this->Form->select("payment_by",$payment,["default"=>($edit)?$data["payment_by"]:"","empty"=>__("Selecione aqui"),"class"=>'form-control','id'=>'payment_by']);
			echo "</div>";			
			echo "</div>";
			...
			echo $this->Form->button(__("Salvar"),['type'=>'button','id'=>'submit_button','class'=>"btn btn-flat btn-success submit_button","name"=>"save_booking"]);
